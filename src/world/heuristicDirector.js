    ...
    spec: {
      ...
      rooms: [
        ...
        room(
          ...
          [
            objectNeed('temple', 'Columned temple', ['temple', 'egypt', 'landmark'], {
              position: [0, 0, -10],
              scale: [1.5, 1.5, 1.5],
              material: 'limestone',
              detail: 'high',
            }),
            objectNeed('column', 'Court column', ['column', 'egypt'], { position: [-3, 0, -5] }),
            objectNeed('column', 'Court column B', ['column', 'egypt'], { position: [3, 0, -5] }),
            objectNeed('obelisk', 'Court obelisk', ['obelisk', 'egypt'], { position: [0, 0, -4], scale: [0.9, 0.9, 0.9] }),
            objectNeed('statue', 'Pharaoh statue', ['statue', 'egypt'], { position: [-5, 0, -7], detail: 'high' }),
            objectNeed('statue', 'Priest statue', ['statue', 'egypt'], { position: [5, 0, -7] }),
            objectNeed('hieroglyphic_panel', 'Wall glyphs', ['hieroglyph', 'egypt'], { position: [-6, 1, -9] }),
            objectNeed('ancient_door', 'Temple door', ['door', 'egypt'], { position: [0, 0, -8.2] }),
